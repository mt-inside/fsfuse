...
extern char *indexnode_host   ( indexnode_t *in );
extern char *indexnode_port   ( indexnode_t *in );
extern char *indexnode_version( indexnode_t *in );
/* NULL if we can't get an ID, e.g. it's statically configured */
extern char *indexnode_id     ( indexnode_t *in );
